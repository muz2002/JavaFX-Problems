...
public class Controller {
    ...
    public void initialize() {
        contacts.add(new Contact("Muzaffar", "Nazarkhudoev", "muzaffar.nazarkhudoev_2026@ucentralasia.org", "+992501848416", "1000000621"));
        contacts.add(new Contact("Sayedzamonuddin", "Sultonsaid", "sayedzamonuddin.adeem_2026@ucentralasia.org", "+992501101450", "1000000650"));
        contacts.add(new Contact("Anis", "Partovov", "anis.partovov_2026@ucentralasia.org", "+992931509080", "1000000700"));
        contacts.add(new Contact("Ramzi", "Shodmonbekov", "ramzi.shodmonbekov_2026@ucentralasia.org", "+992001011043", "1000000250"));
